...
# 80% * eval%
            ...
            # Acking666
            # if(self.nusc.version == 'v1.0-trainval')
...
def compile_data(version, dataroot, data_aug_conf, centroid, bounds, res_3d, bsz,
    ...
    nusc = NuScenes(version='v1.0-mini'.format(version),
                    dataroot='/media/HDD1/users/user1/argho/dataset/v1.0-mini',
                    verbose=print_details)
    if print_details:
        print('loading Maps...')
    map_folder = os.path.join(dataroot, 'maps')
